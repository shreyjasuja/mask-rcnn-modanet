...
class FashionConfig(Config):
    ...
    NUM_CLASSES = 1 + 13  # Background + Fashion Classes
...
class FashionDataset(utils.Dataset):
    ...
    def load_fashion(self, dataset_dir,subset):
        ...
        """
        lst=['bag','belt','boots','footwear','outer','dress','sunglasses','pants','pants','shorts','skirt','headwear','scarf & tie']
        
        assert subset in ["train", "val"]
  

        coco = COCO((os.path.join(dataset_dir,subset, "instances_{}.json").format(subset)))
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        for annotation in annotations:
            class_id = self.map_source_class_id("fashion.{}".format(annotation['category_id']))
            if class_id:
...
def get_inference(model, image_path=None):
  lst=['bag','belt','boots','footwear','outer','dress','sunglasses','pants','pants','shorts','skirt','headwear','scarf & tie']
  print("Running on {}".format(args.image))
  # Read image
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect dresses.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash' or 'inference'")
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/modanet/dataset/",
                        help='Directory of the modanet dataset')
    ...
    if args.command == "train":
        ...
        get_inference(model, image_path=args.image)
    else:
